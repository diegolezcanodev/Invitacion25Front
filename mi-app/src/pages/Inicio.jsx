      ...
      <header className={`relative overflow-hidden w-full transition-colors duration-500 ${
        ...
        <div className="absolute top-4 right-4 z-10">
          <Button
            ...
            size="sm"
            className="bg-white/20 border-white/30 dark:bg-white/20 dark:border-white/30 text-white hover:bg-white/30 dark:hover:bg-white/30 border outline-none ring-0 focus:outline-none focus:ring-0"
          >
                      ...
                      <div className="p-6">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Badge className={`transition-colors duration-500 ${
                            isDarkMode ? "bg-green-800 text-green-300 dark:bg-green-800 dark:text-green-300" : "bg-green-100 text-green-700 dark:bg-green-100 dark:text-green-700"
                          }`}>
                            {event.time}
                          </Badge>
                        </div>
            ...
            <div className="p-6 grid justify-items-center">
              ...
              <Button
                className={`outline-none ring-0 focus:outline-none focus:ring-0 transition-colors duration-300 ${
                  isDarkMode
                    ? "bg-gray-800 text-green-300 hover:bg-gray-700 dark:bg-gray-800 dark:text-green-300 dark:hover:bg-gray-700"
                    : "bg-white text-green-600 hover:bg-green-50 dark:bg-white dark:text-green-600 dark:hover:bg-green-50"
                }`}
